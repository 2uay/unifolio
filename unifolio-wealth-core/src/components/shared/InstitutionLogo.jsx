...
const LOGOS = {
  wealthsimple: { label: 'WS', tone: 'emerald', ring: 'rounded-2xl', accent: 'after:rounded-full' },
  'interactive-brokers': { label: 'IBKR', tone: 'red', ring: 'rounded-lg', wide: true },
  ibkr: { label: 'IBKR', tone: 'red', ring: 'rounded-lg', wide: true },
  questrade: { label: 'Q', tone: 'gold', ring: 'rounded-full' },
  td: { label: 'TD', tone: 'emerald', ring: 'rounded-md' },
  rbc: { label: 'RBC', tone: 'blue', ring: 'rounded-xl', wide: true },
  ...
  schwab: { label: 'CS', tone: 'blue', ring: 'rounded-lg' },
  chase: { label: 'C', tone: 'blue', ring: 'rounded-md' },
...
export default function InstitutionLogo({
  ...
  return (
    <span
      title={name || institution?.name || broker || def.label}
      aria-label={`${name || institution?.name || broker || def.label} logo`}
      className={cn(
