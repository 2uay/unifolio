...
const Switch = React.forwardRef(({ className, ...props }, ref) => (
  <SwitchPrimitives.Root
    className={cn(
      ...
      "border-slate-600 data-[state=unchecked]:bg-slate-700 data-[state=unchecked]:border-slate-600",
      "data-[state=checked]:bg-primary data-[state=checked]:border-primary hover:data-[state=checked]:shadow-lg",
      className
    )}
    {...props}
    ref={ref}>
